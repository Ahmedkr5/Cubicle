...
const MiddleAppChat = React.lazy(() =>
  import('../components/chatApp/MiddlleAppChat')
);
const RightList = React.lazy(() => import('../components/chatApp/RightList'));
const LeftAppChat = React.lazy(() =>
  import('../components/chatApp/leftAppChat')
);
