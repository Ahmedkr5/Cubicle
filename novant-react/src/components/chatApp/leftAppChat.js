                    ...
                    <Card elevation={0} className={classes.root} variant="outlined">
                        <CardContent>
                            ...
                            <Typography variant="body2" component="p">
                                <Accordion style={{overflowY:'scroll',maxHeight:'200px'}}>
                                    <AccordionSummary
                            ...
                            <Typography variant="body2" component="p" style={{ marginTop: '20px' }}>
                                <Accordion>
                                    ...
                                    <AccordionDetails>
                                        <Typography style={{overflowY:'scroll',maxHeight:'300px'}} >
                                                        ...
                                                        if ((msg.file[0] != null) && ((msg.file[0].split('.').pop() == ('png')) || (msg.file[0].split('.').pop() == ('jpg')) || (msg.file[0].split('.').pop() == ('gif')) || (msg.file[0].split('.').pop() == ('jpeg'))))
                                                            return (
                                                                <div className="col-4" style={{ paddingRight: '2px', paddingLeft: '2px', paddingBottom: '4px' }}>
                                                                    <img src={"http://localhost:3001/uploads/" + msg.file[0]} onClick={() => showL("http://localhost:3001/uploads/" + msg.file[0])} className="rounded mx-auto d-block" style={{ height: '100px', width: '125px',cursor: 'pointer'  }} />
                                                                </div>
