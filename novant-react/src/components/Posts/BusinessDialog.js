...
import GroupAddPost from './GroupsFeed/GroupAddPost';
import BusinessAddPost from './BusinessFeed/BusinessAddPost';
...
export default function BusinessGroupDialog(props) {
