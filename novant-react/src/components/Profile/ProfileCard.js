...
export default function ProfileCard(props) {
  ...
  var profileimage =
    'https://mycubicle.herokuapp.com/uploads/' + props.profileimage;
  var coverimage =
    'https://mycubicle.herokuapp.com/uploads/' + props.coverimage;
    ...
    <>
      ...
      >
        <CardMedia
          ...
          image={coverimage}
          onClick={() =>
            showL('https://mycubicle.herokuapp.com/uploads/' + props.coverimage)
          }
